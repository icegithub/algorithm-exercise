...
#define N 5 					/* the size of the matrix */
...
int stepOfWarshall = 0;
double timeOfWarshall = 0;
int stepOfFloyd = 0;
double timeOfFloyd = 0;
...
WarshallAlgorithm(adjacency_matrix_t *g)
{
  ...
  finish = clock();
  timeOfWarshall = (double)(finish - start)/CLOCKS_PER_SEC;
...
FloydAlgorithm(adjacency_matrix_t *g)
{
  ...
  finish = clock();
  timeOfFloyd = (double)(finish - start)/CLOCKS_PER_SEC;
  return 0;
}
...
#define N 5
  ...
  printf("\n=============Floyd=================\n");
  vertex_t v2[N] = {'a', 'b', 'c', 'd', 'e'};
  edge_t e2[N][N] = {
    {0, INFINITY, 3, INFINITY, INFINITY},
    {2, 0, INFINITY, INFINITY, 7},
    {INFINITY, 7, 0, 1, INFINITY},
    {6, INFINITY, INFINITY, 0, INFINITY},
    {8, 4, 2, INFINITY, 6}
  };
  init_adjacency_matrix(&g, vexnum);
...
/*   destory_adjacency_matrix(&g); */
  ...
  printf("Hello, world\n");
  printf("Step Of Warshall: %d\n", stepOfWarshall);
  printf("Time Of Warshall: %lf\n", timeOfWarshall);
  printf("Step of Floyd: %d\n", stepOfFloyd);
  printf("Time Of Floyd: %lf\n", timeOfFloyd);
  return 0;
}
